                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        @else
                            <li class="nav-item dropdown ms-auto">
                                <a id="navbarDropdown" class="nav-link dropdown-toggle text-end"  data-bs-toggle="dropdown" aria-expanded="false" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
